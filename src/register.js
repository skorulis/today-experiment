var RegisterForm = React.createClass({
	...
	return (
		<form id="register-form" onSubmit={this.handleSubmit}>
			...
			<div className="form-group">
				<input type="email" name="email" ref="email" tabIndex="2" className="form-control" placeholder="Email Address" />
			</div>
			<div className="form-group">
				<input type="password" name="password" ref="password" tabIndex="3" className="form-control" placeholder="Password"/>
			</div>
			<div className="form-group">
				<input type="password" name="confirmPassword" ref="confirmPassword" tabIndex="4" className="form-control" placeholder="Confirm Password"/>
			</div>
			<div className="form-group">
				<div className="row">
					...
					<div className="panel-body">
						<div className="row">
							<div className="col-lg-12">
								...
								<RegisterForm onRegisterComplete={this.props.onLogin} />
							</div>
						</div>
					</div>
				</div>
